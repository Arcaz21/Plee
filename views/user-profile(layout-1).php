...
<div id="main-wrapper"> 
  ...
  <div class="compny-profile"> 
    ...
    <div class="profile-bnr user-profile-bnr">
      <div class="container">
        <div class="pull-left">
          <h2><?php $db = new UserModels; $data = $db->showUser($_SESSION['username']); echo $data->fname; ?></h2>
                    ...
                    <div class="listing-ver-3">
                      ...
                      <div class="listing-inner">
                        <div class="listing-content">
                          ...
                          <p>Proin gravida nibh vel velit auctor aliquet aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio pellentesque habitant morbi tristique senectus et netus et malesuada. <a href="single_job.php">read more</a></p>
